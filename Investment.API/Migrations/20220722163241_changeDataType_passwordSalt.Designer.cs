...
namespace Investment.API.Migrations
{
    ...
    [Migration("20220722163241_changeDataType_passwordSalt")]
    partial class changeDataType_passwordSalt
    {
            ...
            modelBuilder.Entity("Investment.Domain.Entities.UserAsset", b =>
                {
                    ...
                    b.Property<DateTime>("UtcBoughtAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("UtcSoldAt")
                        .HasColumnType("datetime2");
